...
public class TST<Value> {
	...
	public static void activateSearchSystem(String stringInput) throws IOException {
		...
		Object[][] arrWithFullInfo = new Object[ARR_SIZE][2];
		...
		linesArray = readBusStations.fileToLinesArray(fnStops, ARR_SIZE);
		stationsArray = readBusStations.linesArrToTST(linesArray, ARR_SIZE);
		arrWithFullInfo = readBusStations.saveResults(linesArray, ARR_SIZE);

		//filling the tst with the bus stop names.
		for (int i = 0; count < ARR_SIZE - 1; i++) {
			count = count + 1;
